...
Sebelum menggunakan bot ini ada baiknya mengumpulkan niat baik 😁

💵TOLONG BANTU DOA AGAR BOT INI BISA TERUS BERJALAN💵


INFO BOT! :
🔱 *AUTHOR*: VITO
🔱 *GITHUB*: https://github.com/Alvito-ai/mybot
🔱 *INSTAGRAM*: ${instagram}
🔱 *YOUTUBE*: ${youtube}
🔱 *TELEGRAM* : ${telegram}
